...
class LLM::Transport
  ...
  # built-in adapter for Ruby's {Net::HTTP Net::HTTP}. It manages HTTP
  # connections for {LLM::Provider}, handles transient and persistent
  # clients, tracks active requests by owner, and interrupts in-flight
